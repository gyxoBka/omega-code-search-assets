; omega-typescript
;
; TypeScript is JavaScript with a type system written into the source, so one
; file declares two vocabularies at once: the values a module exports --
; classes, functions, constants -- and the types it declares for them --
; interfaces, type aliases, enums, the members of both. The questions asked of
; a TypeScript file are: where is this class, function, interface or type
; alias defined; what does this module import, from which module, and what
; does a short alias stand for; what does this module export; what does this
; class extend or implement; who calls this; what type is written here; and
; what is this decorated with. Every pattern below answers one of them.
;
...
;
; Test-runner shapes (`describe`, `it`, `test.each`), decorator metadata
; object literals and fluent builder chains are one library's call shape, not
; a TypeScript construct. They belong in an overlay under `frameworks/` and
; are not here.
